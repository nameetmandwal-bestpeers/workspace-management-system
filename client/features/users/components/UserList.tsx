...
export default function UserList({IsReadOnly=true}:{IsReadOnly:boolean}) {
        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[900px] text-left">
            ...
            <thead className="border-b border-gray-200 bg-gray-50">
              <tr>
               {!IsReadOnly && <th className="w-12 px-5 py-4">
                  <input
                    onChange={(e) =>
               ...
               {!IsReadOnly &&  <th className="w-24 px-5 py-4 text-right text-xs font-semibold uppercase tracking-wider text-gray-500">
                  Actions
                </th>}
              </tr>
            </thead>
